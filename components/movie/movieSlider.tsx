...
const MovieSlider: React.FC<movieSliderProps> = ({ data, openMovieModal }) => {
      ...
      {isMoveButtonVisible && (
        <>
          <div
            ...
            className={`${scrollX >= 0 ? "hidden" : "visible"} absolute w-14 lg:h-40 h-24 left-0 flex items-center justify-center text-3xl transition bg-black bg-opacity-40 hover:bg-opacity-60 hover:text-4xl cursor-pointer z-40`}
          >
            <AiOutlineLeft />
          </div>
          <div
